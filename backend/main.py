...
HF_SECRET = os.getenv("HF_SECRET")    # Set in env

@app.post("/generate")
async def generate(prompt: str):
    # Step 1: Text-to-Image (Nano Banana)
    ...
    # Step 2: Image-to-Video (Kling 2.5 Turbo)
    video_url = "https://platform.higgsfield.ai/v1/models/kling-2-5/generations"
    video_data = {"params": {"image_url": image_url, "duration": 5}}  # Adjust params as per docs
